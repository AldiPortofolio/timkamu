		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-11 col-md-8 col-lg-4">
					<h1 class="rajdhani-bold text-center">Verification needed</h1>
				</div>
			</div> 
		</div>
	</div>
			...
			<div class="row justify-content-center">
				<div class="col-11 col-md-8 col-lg-4">
					...
					<div class="form-group mana-control">
						<label class="mana-control">Kode OTP</label>
                        <input type="text" name="otpCode" class="form-control mana-control otp-code">
...
<script>
	$(document).ready(function() {
		...
		$('body').on('click', '.otp-submit-btn', function(e) {
			...
			var target = $(this);
			var target2 = $('#login-error-email-not-found');
