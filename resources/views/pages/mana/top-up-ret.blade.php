				...
				<div class="col-md-8 col-lg-6">
					...
					<div class="top-up-page-header">
						<div class="page-hero-container">
							<img src="{{ asset('img/game-thumbs/hero-ret.jpg') }}" class="main-hero">
			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6">
					...
					<div class="form-group mana-control">
						...
						<input type="text" class="form-control mana-control" placeholder=""><small class="font-size-14 o3 text-italic mt-10 d-block fw-300">contoh: 1234567890, ItemKu, Eternal Love*</small>
					</div>
				...
				<div class="col-md-8 col-lg-6">
					...
					<div class="shelf-container d-flex flex-wrap align-items-center">
						<?php for ($i=0; $i < 15; $i++): ?>
							<div class="shelf-item nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="money money-14 right">2,349<img src="{{ asset('img/currencies/bcc.png') }}"></span>
								</div>
							</div>
						<?php endfor; ?>
						...
						<div class="shelf-item full-width nominal-choice-btn d-flex scale-onclick">
							<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
								<span class="money money-14 right">Premium</span>
							</div>
						</div>
					</div>
						...
						<div class="pg-shelf-item pg-choice-btn d-flex scale-onclick">
							<div class="pg-shelf-item-inner d-flex bd20 align-items-center">
								...
								<div class="pg-price slashed text-right poetsenone-reg font-size-16 black-08 d-flex justify-content-end">
									<span class="old">Rp 2,196,500</span>
									<span class="new">Rp 1,800,000</span>
								</div>
							</div>
						</div>
