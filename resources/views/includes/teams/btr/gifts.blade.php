...
<div class="gifts">
	<div class="item head">
		Support Bigetron by giving them these items <i data-feather="info" class="icon" data-toggle="tooltip" data-placement="top" title="When you give items to your favorite team, their [Total Incoming Support] value will increase and your name will be recorded in the supporter table."></i>
	</div>
	@foreach ($items as $item)
        <div class="item">
			...
			<div class="tmx">
				...
				<div class="gx gift-action">Berikan ke Bigetron</div>
			</div>
		</div>
    @endforeach
</div>