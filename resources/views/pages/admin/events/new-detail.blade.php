                            ...
                            @if($item['type'] === '1')
                                <div class="vert-panel-target panel-{{ $item['id'] }}">
                                    @if(isset($item['item_active']))
                                        @if(isset($item['team_left']) && isset($item['team_right']))
                                            <div class="row mb-20">
                                                <div class="col-12">
                                                    <div class="card h-100">
                                                        <div class="card-body">
                                                                ...
                                                                <form action="{{ route('admin.events.bet-rules.edit', ['id' => $item['item_active']->id]) }}" method="post">
                                                                    @else
                                                                        <form action="{{ route('admin.events.bet-rules') }}" method="post">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-6">
                                                                                    <p><img src="{{ asset($item['team_left']->logo.'-200.png') }}" class="bet-panel-team-thumb">{{ $item['team_left']->name }}</p>
                                                                                    <div class="row">
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                                <a href="{{ url('admin-tkmu/update-winner-winlose/'.$item['id'].'/left') }}" class="btn btn-sm btn-block @if($item['value'] === $item['team_left']->id) btn-success @else btn-light @endif radio-set-winner">@if($item['value'] === $item['team_left']->id) Winner @else Set as winner @endif</a>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        @if($item['bp_place'] > 0)
                                                                                            <button type="button" class="btn btn-sm btn-block btn-light" id="row-detail-left-{{ $item['id'] }}" disabled>{{ $item['team_left_total_bets'] }} bets ({{ round($item['team_left_total_bets'] * 100 / $item['bets'], 2) }} %) - {{ $item['team_left_total_bp'] }} BP ({{ round($item['team_left_total_bp'] * 100 / $item['bp_place'], 2) }}%)</button>
                                                                                        @else
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="hidden" class="form-control form-control-sm" name="value_left_id" @if($item['item_active'] != null) value="{{ $item['team_left']->id }}" @endif>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-6">
                                                                                    <p><img src="{{ asset($item['team_right']->logo.'-200.png') }}" class="bet-panel-team-thumb">{{ $item['team_right']->name }}</p>
                                                                                    <div class="row">
                                                                                        <div class="col-6">
                                                                                            <div class="form-group">
                                                                                                <a href="{{ url('admin-tkmu/update-winner-winlose/'.$item['id'].'/right') }}" class="btn btn-sm btn-block @if($item['value'] === $item['team_right']->id) btn-success @else btn-light @endif radio-set-winner" data-team="right" data-id="{{ $item['id'] }}">@if($item['value'] === $item['team_right']->id) Winner @else Set as winner @endif</a>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        @if($item['bp_place'] > 0)
                                                                                            <button type="button" class="btn btn-sm btn-block btn-light" id="row-detail-right-{{ $item['id'] }}" disabled>{{ $item['team_right_total_bets'] }} bets ({{ round($item['team_right_total_bets'] * 100 / $item['bets'], 2) }} %) - {{ $item['team_right_total_bp'] }} BP ({{ round($item['team_right_total_bp'] * 100 / $item['bp_place'], 2) }}%)</button>
                                                                                        @else
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-12">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="hidden" class="form-control form-control-sm" name="value_right_id" @if($item['item_active'] != null) value="{{ $item['team_right']->id }}" @endif>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <table class="table table-sm table-bordered table-hover mb-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="w-10">{{ $item['team_left']->name }}</th>
                                                            <th class="w-10">{{ $item['team_right']->name }}</th>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <p>{{ $item['name'] }}</p>
                                                            <div class="form-group">
                                                                <button type="button" class="btn btn-sm btn-block btn-light" disabled>Total {{ number_format($item['bp_place'], 0, '.', ',') }} BP</button>
                                                            </div>
                                                            @if($item['item_active'] != null)
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <div class="form-group">
                                                                @if($item['bp_place'] > 0)
                                                                    <button type="button" class="btn btn-sm btn-block btn-light" id="row-detail-under-{{ $item['id'] }}" disabled>{{ $item['under_total_bets'] }} bets ({{ round($item['under_total_bets'] * 100 / $item['bets'], 2) }} %) - {{ number_format($item['under_total_bp'], 0, '.', ',') }} BP ({{ round($item['under_total_bp'] * 100 / $item['bp_place'], 2) }}%)</button>
                                                                @else
                                                        ...
                                                        <div class="col-3">
                                                            ...
                                                            <div class="form-group">
                                                                @if($item['bp_place'] > 0)
                                                                    <button type="button" class="btn btn-sm btn-block btn-light" id="row-detail-over-{{ $item['id'] }}" disabled>{{ $item['above_total_bets'] }} bets ({{ round($item['above_total_bets'] * 100 / $item['bets'], 2) }} %) {{ number_format($item['above_total_bp'], 0, '.', ',') }} BP ({{ round($item['above_total_bp'] * 100 / $item['bp_place'], 2) }}%)</button>
                                                                @else
                                                                    <button type="button" class="btn btn-sm btn-block btn-light" id="row-detail-over-{{ $item['id'] }}" disabled>0 bets (0%) - 0 BP (0%)</button>
                                                                @endif
                                                            </div>
                                                            <div class="form-group">
                                                ...
                                                <div class="card h-100 @if($itm->active === '1') card-tebak-score-active @endif @if(json_decode($itm->value_detail)->bonus_locked === '1' && $itm->active === '1') border-warning @endif">
                                                    <div class="card-body">
                                                        <p>
                                                            ...
                                                            - {{ json_decode($itm->value_detail)->team_right }} {{ $event->team_right->name }} <img src="{{ asset($event->team_left->logo.'-200.png') }}" class="bet-panel-team-thumb right">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.events.bet-rules') }}" method="post">
                        @csrf
                        <input type="hidden" name="event_id" value="{{ $event->id }}">
                        <input type="hidden" name="game_id" value="{{ $event->league_games->game_id }}">
                        <input type="hidden" name="event_bet_category_id" class="event_bet_category_id">
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Team A</label>
                                <select name="team_left" id="team_left" class="form-control form-control-sm first-focus">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm"  name="value_left">
                            </div>
                            <div class="form-group">
                                <label>Team B</label>
