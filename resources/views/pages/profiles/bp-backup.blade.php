...
<body class="bg1">
	...
	<div class="root">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h2 class="rajdhani-bold font-30 text-uppercase color-white mb-0">Catatan Transaksi BP</h2>
						...
						<div class="right">
							<div class="curr-stat">
								<div class="inside">
									...
									<p>1,600 <img src="img/currencies/bp.svg" class="curr-icon"></p>
								</div>
							</div>
							<div class="curr-stat">
								<div class="inside">
							...
							<div class="curr-stat">
								<div class="inside">
									...
									<p>0 <img src="img/currencies/bp.svg" class="curr-icon"></p>
								</div>
							</div>
							...
							<div class="table-wrapper">
								<table class="metro-table">
									...
									<tbody>
										<tr>
											<td>[Win reward] EVO vs RRQ</td>
											<td><span class="curr-bp">+1,500</span> <img src="img/currencies/bp.svg" class="curr-icon"></td>
											<td>7/10/2020, 6:15 PM</td>
										</tr>
										<tr>
											<td>Convert from LP</td>
											<td><span class="curr-bp">+100</span> <img src="img/currencies/bp.svg" class="curr-icon"></td>
											<td>7/10/2020, 6:15 PM</td>
										</tr>
									</tbody>
								</table>
