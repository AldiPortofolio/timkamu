...
@section('body_class', 'mana-ui isi-pulsa-telkomsel')
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6">
					<h1 class="rajdhani-bold">Paket Telkomsel</h1>
				</div>
			</div> 
		</div>
	</div>
				...
				<div class="col-md-8 col-lg-6">
					...
					<div class="shop-panel active panel1">
						<div class="shelf-container d-flex flex-wrap align-items-center">
							<?php for ($i=0; $i < 14; $i++): ?>
								<div class="shelf-item shelf-full nominal-choice-btn d-flex scale-onclick">
									<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
										<span class="o5 mr-1">Pulsa</span>&nbsp;&nbsp;<span class="money money-14 money-inline right">IDR 635,000</span>
									</div>
								</div>
							<?php endfor; ?>
						</div>
					...
					<div class="shop-panel panel2">
						<div class="shelf-container d-flex flex-wrap align-items-center">
							<?php for ($i=0; $i < 10; $i++): ?>
								<div class="shelf-item shelf-half nominal-choice-btn d-flex scale-onclick">
									<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
										<span class="money money-14 money-inline right mr-1">100 MB</span>&nbsp;&nbsp;<span class="o5 font-size-14">7 Hari</span>
									</div>
								</div>
							<?php endfor; ?>
						</div>
