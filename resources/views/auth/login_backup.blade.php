                        ...
                        @if(!Request::is('admin-tkmu') && !Request::is('admin-tkmu/*'))
                            <div class="form-group mana-control mt-20">
                                <div class="scmd-login-wrapper d-flex align-items-center justify-content-start">
                                    <div class="scmd-btn gg" data-url="{{ url('redirect-socialite?provider=google') }}"><img src="{{ asset('img/social/gg.svg') }}"></div>
                                    <div class="scmd-btn fb" data-url="{{ url('redirect-socialite?provider=facebook') }}"><img src="{{ asset('img/social/fb.svg') }}"></div>
