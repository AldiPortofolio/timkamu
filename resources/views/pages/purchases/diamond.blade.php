				...
				<div class="col-md-8 col-lg-6">
					<div class="shop-gallery-container d-flex flex-wrap align-items-start mb-20">
						@foreach ($shops as $shop)
							<div class="shop-item">
								<a href="@if($shop->active === '0') # @else {{ url('purchase/detail?name=diamond&type='.$shop->alias) }} @endif" class="shop-item-inner @if($shop->active === '0' && $shop->meta === 'Coming Soon')game-comingsoon @elseif($shop->active === '0') game-unvailable @endif" @if($shop->active === '0') data-reason="{{ $shop->reason }}" data-open="{{ \Carbon\Carbon::parse($shop->open_date)->format('l d M Y H:i') }}" @endif>
					...
					<div class="dashboard-info-group mb-10">
						<div class="info-horizontal bg020 bd20 d-flex align-items-center justify-content-center">
							<div class="info-horizontal-left o5">Jadwal offline</div>
							<div class="info-horizontal-right text-right">23.00 - 09.00 WIB</div>
						</div>
					</div>

					<div class="dashboard-info-group mb-10">
						<div class="info-horizontal bg020 bd20 d-flex align-items-center justify-content-center">
							<div class="info-horizontal-left o5">Jadwal restock</div>
							<div class="info-horizontal-right text-right">17.00 - 19.00 WIB</div>
						</div>
					</div>

					<div class="dashboard-info-group mb-20">
						<div class="info-horizontal bg020 bd20 d-flex align-items-center justify-content-center">
							<div class="info-horizontal-left o5">Minggu</div>
							<div class="info-horizontal-right text-right">Offline</div>
						</div>
					</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-mid font-size-16 o5">
					Terima kasih atas pembelian game currency di Timkamu. Pesanan kamu sedang diproses.
				</div>
