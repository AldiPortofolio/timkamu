                    ...
                    <div class="left">
                        ...
                        <div class="tmw-logo">
                            ...
                            <div class="teams-detail-join">
                                <span data-toggle="modal" data-target="#join-team-require-sign-in"><i data-feather="heart" class="icon"></i>Menjadi Fans ONIC</span>
                            </div>
                            
                            <!-- kalau blm join tim manapun: -->
                            @elseif(!$user->teams)
                            <div class="teams-detail-join">
                                <span data-toggle="modal" data-target="#join-team-confirm"><i data-feather="heart" class="icon"></i>Menjadi Fans ONIC</span>
                            </div>

                            <!-- kalau sudah join di tim yang sedang dilihat: -->
                            @elseif($user->fans_team_id === 1)
                            <div class="teams-detail-join joined">
                                <span><i data-feather="heart" class="icon"></i>Kamu adalah fans ONIC</span>
                            </div>

                            <!-- kalau sudah join di tim lain: -->
                            @elseif($user->fans_team_id !== null && $user->fans_team_id !== 1)
                            <div class="teams-detail-join">
                                <span data-toggle="modal" data-target="#join-other-team-already"><i data-feather="heart" class="icon"></i>Menjadi Fans ONIC</span>
                            </div>
                            @endif
                        </div>
...
<div id="join-team-confirm" class="modal metro" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="nwcls">
                <a href="#" data-dismiss="modal" class="ctagp" id="btn-confirm">Confirm</a>
            </div>
        </div>
    </div>
</div>

<div id="join-other-team-already" class="modal metro" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <h3 class="colored">Menjadi Fans</h3>
            <i data-feather="x" class="icon tutup" data-dismiss="modal"></i>
            <div class="modal-body posrel">
                <div class="message">
                    <p>Kamu sudah menjadi fans dari tim EVOS.</p>
                    <p>Yakin mau ganti menjadi fans tim ONIC?</p>
                </div>
            </div>
            <div class="nwcls">
...
<div id="join-team-require-sign-in" class="modal metro" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <h3 class="colored">Menjadi Fans</h3>
            <i data-feather="x" class="icon tutup" data-dismiss="modal"></i>
            <div class="modal-body posrel">
                <div class="message">
                    <p>Untuk menjadi fans kamu perlu sign in Timkamu.com</p>
                </div>
            </div>
            <div class="nwcls">
                <a href="#" data-dismiss="modal">Batal</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btn-confirm').on('click', function(event) {
            ...
            setTimeout(function(){
                var urlString = ("{{ url('teams/fans?name=onic') }}").replace(/&amp;/g, '&');
        ...
        $('.btn-donate-item').on('click', function(event) {            
            ...
            setTimeout(function(){
                ...
                $.ajax({
                    url: "{{ url('ajax/donate-team-items/1') }}",
                    method: 'post',
                    data : {
                        item_id : itemId
                    },
                    success: function(result) {
                        if(result.status === 'error') {
                            ...
                            $('#total-lp-menu').text(result.total_lp);
                        }
                    }
                })
