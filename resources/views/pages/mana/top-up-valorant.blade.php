				...
				<div class="col-md-8 col-lg-6">
					...
					<div class="top-up-page-header">
						<div class="page-hero-container">
							<img src="{{ asset('img/game-thumbs/hero-valorant.jpg') }}" class="main-hero">
			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6">
					...
					<div class="form-group mana-control">
						...
						<input type="text" class="form-control mana-control" placeholder="">
					</div>
						...
						<?php for ($i=0; $i < 15; $i++): ?>
							<div class="shelf-item nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="money money-14 right">2,349<img src="{{ asset('img/currencies/valorant-points.svg') }}"></span>
								</div>
							</div>
						<?php endfor; ?>
