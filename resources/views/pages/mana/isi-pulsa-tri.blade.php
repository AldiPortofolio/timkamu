...
@section('body_class', 'mana-ui isi-pulsa-tri')
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6">
					<h1 class="rajdhani-bold">Paket Tri</h1>
				</div>
			</div> 
		</div>
	</div>
				...
				<div class="col-md-8 col-lg-6">
					...
					<div class="shop-panel active panel1">
						<div class="shelf-container d-flex flex-wrap align-items-center">
							...
							<div class="shelf-item shelf-100 shelf-full nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="poetsenone-reg mr-1">1.5 GB</span><span class="o5">+ Bonus Pulsa 2000</span>
								</div>
							</div>
							
							<div class="shelf-item shelf-100 shelf-full nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="poetsenone-reg mr-1">2 GB</span><span class="o5">+ Bonus Pulsa 2000</span>
								</div>
							</div>
							
							<div class="shelf-item shelf-100 shelf-full nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="poetsenone-reg mr-1">3 GB</span><span class="o5">+ Bonus Pulsa 2000</span>
								</div>
							</div>
							
							<div class="shelf-item shelf-100 shelf-full nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="poetsenone-reg mr-1">6 GB</span><span class="o5">+ Bonus Pulsa 2000</span>
								</div>
							</div>
							
							<div class="shelf-item shelf-100 shelf-full nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="poetsenone-reg mr-1">6 GB</span><span class="o5">+ Unlimited YTB + Sosmed 30 hari</span>
								</div>
							</div>
							
							<div class="shelf-item shelf-100 shelf-full nominal-choice-btn d-flex scale-onclick">
								<div class="shelf-item-inner d-flex bg020 bd20 justify-content-center">
									<span class="poetsenone-reg mr-1">10 GB</span><span class="o5">+ Unlimited YTB + Sosmed 30 hari</span>
								</div>
							</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6">
					...
					<div class="form-group mana-control mb-50">
						...
						<a href="/mana/isi-pulsa-index" class="mana-btn-54 mana-btn-opaque">Pilih provider lain</a>
					</div>
