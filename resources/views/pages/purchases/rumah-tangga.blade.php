...
@section('page_title', "Rumah Tangga")
				...
				<div class="col-md-8 col-lg-6">
					<div class="shop-gallery-container d-flex flex-wrap align-items-start">
                        @foreach ($shops as $shop)
							<div class="shop-item">
								<a href="@if($shop->active === '0') # @else {{ url('purchase/detail?name=rumah-tangga&type='.$shop->alias) }} @endif" class="shop-item-inner @if($shop->active === '0' && $shop->meta === 'Coming Soon')game-comingsoon @elseif($shop->active === '0') game-unvailable @endif" @if($shop->active === '0') data-reason="{{ $shop->reason }}" data-open="{{ \Carbon\Carbon::parse($shop->open_date)->format('l d M Y H:i') }}" @endif>
...
<section id="page-modals">
    @if(session('success-rumah-tangga-purchase'))
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-mid font-size-16 o5">
					Terima kasih atas pembelian {{ session('success-rumah-tangga-purchase') }} di Timkamu. Pesanan kamu sedang diproses.
				</div>
